...
dureader_context_list = get_data_from_file('dureader_robust-data/train.json')
print("dureader train length is:")
print(len(dureader_context_list))

squad2_context_list = get_data_from_file('train-v2.0.json')
print('squad2 train length')
...
get_dict_to_text(sample_words_cn, 'dict_dureader_train.txt')
get_dict_to_text(sample_words_en, 'dict_squad2_train.txt')
